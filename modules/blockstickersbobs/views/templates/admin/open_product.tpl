...
<div class="panel">
	...
	<form action="{$current_url|escape:'htmlall':'UTF-8'}&amp;open_product=1" method="post" class="form-horizontal clearfix">
				...
				<table class="table">
					...
					{foreach from=$stickers key=k item=sticker}
						<tr class="{if $k is even} odd{/if}"
							onclick="document.location = '{$current_url|escape:'htmlall':'UTF-8'}&amp;sticker=1&amp;redirect=openproduct&amp;id_sticker={$sticker.id_sticker|escape:'quotes':'UTF-8'}'"
								>
							...
							<td class="pointer left">{$sticker.id_sticker|escape:'quotes':'UTF-8'}</td>
